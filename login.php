...
<div align="center"><h1>Driving School</h1><h2>Login Panel</h2></div>
<hr />
...
if(isset($_POST['submit'])){
	...
	if ($count == 1) //user sucessfully login
	{
	   ...
	   <div align="center" class="alert alert-danger" role="alert"><h4>Error 1042: We are not able to redirect you ! !</h4></div>
		<?php
		}
}else { ?>
